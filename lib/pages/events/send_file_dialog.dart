import 'package:chat_app/utils/resize_image.dart';
...
class SendFileDialogState extends State<SendFileDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final fileName = widget.files.length == 1
        ...
        // :AppLocalizations.of(context)!.countFiles(widget.files.length.toString());
          ...
          Row(
            children: <Widget>[
              ...
              InkWell(
                ...
                child: Text(
                  // '${AppLocalizations.of(context)!.sendOriginal} ($sizeString)'
                  ""),
              ),
            ],
          )
